   ...
   >
     ...
     <div className="hero-content text-neutral-content text-center">
       <div className="">
         ...
         <Link to="/tokenize" className="px-8 py-3 bg-white text-sage-600 border border-sage-600 rounded-lg hover:bg-sage-50 transition-colors">Tokenize Property</Link>
         </div>
       </div>
     </div>
   </div>
